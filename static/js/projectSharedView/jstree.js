$(document).ready(function() {
    $('#filetree').on('select_node.jstree', function(e, data) {
        ...
        if (frm !== to) {
            $.ajax({
                url: '/project/share/' + project + '/file/move/' + shareId,
                method: 'POST',
                data: {
                    'to': to,
                    'from': frm,
        ...
        "core" : {
            ...
            "data" : {
                "url" : function(node) {
                    if (node.id == '#') {
                        return '/project/share/' + project + '/files/' + shareId;
                    }
                    return '/project/share/' + project + '/files/' + shareId + '?path=' + node.id;
                },
                "data" : function (node) {
                ...
                "delete" : {
                    ...
                    "action"            : function(obj) {
                        ...
                        swal({
                            ...
                            $.ajax({
                                url: '/project/share/' + project + '/file/del/' + shareId,
                                method: 'POST',
                                data: {path: n.id},
                                success: function(resp) {
                                    if (resp.error) {
